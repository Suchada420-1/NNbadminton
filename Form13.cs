...
namespace Projectfinal
{
    public partial class Form13 : Form
    {
        ...
        public Form13(string court, DateTime date, int userId, string userEmail, string userfname, string userlname)
        {
            InitializeComponent();
            selectedCourt = court;
            selectedDate = date;
        ...
        private List<(TimeSpan start, TimeSpan end)> GetBookedTimeSlots()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT StartTime, EndTime FROM bookings WHERE BookingDate = @date AND CourtID = 3";
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            endTimeSelected = TimeSpan.Parse(comboBox2.SelectedItem.ToString());
        }
        ...
        private void comboBoxStartTime_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                comboBox2.Items.Add(tempEndTime.ToString(@"hh\:mm"));
        ...
        private void Confirmbut_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxStartTime.SelectedItem != null && comboBox2.SelectedItem != null)
            {
                TimeSpan startTime = TimeSpan.Parse(comboBoxStartTime.SelectedItem.ToString());
                TimeSpan endTime = TimeSpan.Parse(comboBox2.SelectedItem.ToString());
